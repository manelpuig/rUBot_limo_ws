...
def clbk_laser(msg):
    ...
    if not isScanRangesLengthCorrectionFactorCalculated:
            ...
            print("Lidar_Factor= "+str(scanRangesLengthCorrectionFactor))

    bright_min = int(90 * scanRangesLengthCorrectionFactor)
    bright_max = int(120 * scanRangesLengthCorrectionFactor)
    right_min = int(60 * scanRangesLengthCorrectionFactor)
    right_max = int(90 * scanRangesLengthCorrectionFactor)
    fright_min = int(20 * scanRangesLengthCorrectionFactor)
    fright_max = int(60 * scanRangesLengthCorrectionFactor)
    front_min= int(0 * scanRangesLengthCorrectionFactor)
    front_max = int(20 * scanRangesLengthCorrectionFactor)
